...
hotairballoon = loadAnimation("Hot Air Ballon-02.png", "Hot Air Ballon-03.png", "Hot Air Ballon-01.png")
balloonImg1 = loadImage("Hot Air Ballon-02.png");
balloonImg2 = loadImage("Hot Air Ballon-03.png");
balloonImg3 = loadImage("Hot Air Ballon-01.png");
...
function draw() {
  ...
  fill("blue");
  textSize(20);
  text("Use up and down keys to grow the size of the balloon Hot Air Balloon", 30, 30);
